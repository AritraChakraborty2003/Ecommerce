...
const SearchPage = () => {
  ...
  return (
    <>
      <Header />
      {(data.length === 0 && (
        <div className="display  flex flex-wrap gap-5  w-[100vw] lg:w-[100vw] h-96 justify-center items-center p-10 bg-darkwhite">
          <p>0 results found</p>
        </div>
      )) || (
        <div className="display  flex flex-wrap gap-5  w-[100vw] lg:w-[100vw] justify-center items-center p-10 bg-darkwhite">
          {data.map((val) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                {val.brand != "NA" && (
                  <p className="mb-3 font-semibold text-sm text-brown dark:text-gray-400">
                    brand:&nbsp;<span className="text-black">{val.brand}</span>
                  </p>
                )}
