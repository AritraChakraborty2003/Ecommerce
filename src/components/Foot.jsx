...
const Foot = () => {
  return (
    <>
      {(screen.width < 1280 && (
        <div className="flex-wrap footer-body-w-12/12  bg-mustardyellow flex">
          ...
          <div className="leftPart border-solid border-2 w-[90vmin] mt-5">
            This is a text
          </div>
        </div>
      )) ||
        ...
        (screen.width >= 1728 && screen.width < 2048 && (
          <div className="flex-wrap footer-body-w-12/12 h-96 bg-mustardyellow flex">
            <div className="leftPart w-[85vmin]">
              <div
                className="imgHolder h-15
